...
export async function signInWithSnapchat() {
  try {
    ...
    console.log('📌 [Snapchat OAuth] Redirect URI generated by app:', redirectUri);
    // Show alert on device in development to easily read the redirect URI
    if (__DEV__) {
      Alert.alert('Debug Snapchat URI', `Add this URI to your Snapchat Console:\n\n${redirectUri}`);
    }
